<div align="center">
  ...
  ***双语流转，克制智能化。让阅读回归纯粹与沉浸。***
  ...
  [官方网站](https://ohmyangboy.github.io/PaperRss/) · [下载最新版 v1.2.1](https://github.com/ohmyangboy/PaperRss/releases/latest) · [问题反馈](https://github.com/ohmyangboy/PaperRss/issues)
...
从 [Releases](https://github.com/ohmyangboy/PaperRss/releases/latest) 下载 `PaperRss-v1.2.1.dmg`，打开后将 PaperRss 拖入 Applications 文件夹。
