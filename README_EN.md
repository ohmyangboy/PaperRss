...
**Beta v1.3.3-beta.3 (Build 24)**: Improve sidebar transitions, compact toolbar layout and Zen mode updates. Includes RSS image and content adaptation fixes. [Download Beta](https://github.com/ohmyangboy/PaperRss/releases/tag/v1.3.3-beta.3).
